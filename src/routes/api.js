...
async function apiRoutes(fastify) {
  ...
  fastify.get(
    '/categories-with-notes-and-groups',
    {
      schema: {
        description:
          'Get all categories with their notes and parent category groups from Actual Budget',
        tags: ['API'],
        querystring: {
          type: 'object',
          properties: {
    ...
    async (request, reply) => {
      try {
        ...
        const categoriesWithNotesAndGroups =
          await actualClient.getCategoriesWithNotesAndGroups(options);
        return {
          success: true,
            ...
            properties: {
              ...
              error: {
                ...
                properties: {
                  ...
                  message: {
                    type: 'string',
                    example: 'Subtransaction amounts must sum to transaction amount'
                  }
                }
              }
            }
